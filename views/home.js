...
export default {
  ...
  <div class="innerdiv2">
    <div class="vansterdiv">
      ...
      <img src="../images/fakenews.jpg" alt="Italian Trulli" style="width:100%;max-width:800px"></img>
        <p>
        ...
        <img src="../images/riot.jpg" alt="riot" style="width:100%;max-width:800px"></img>
